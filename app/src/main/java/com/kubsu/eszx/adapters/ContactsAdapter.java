package com.kubsu.eszx.adapters;
...
public class ContactsAdapter  extends RecyclerView.Adapter<ContactsAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            textView.setOnClickListener( v -> {
                listener.onContactClick(AddressBookDatabaseDescription.Contact.buildContactUri(contactID));
            });
    ...
    public void onBindViewHolder(@NonNull ContactsAdapter.ViewHolder viewHolder, int position) {
        ...
        // get the contact id
        long contactID = cursor.getLong(cursor.getColumnIndex(AddressBookDatabaseDescription.Contact.COLUMN_ID));
        LogWrapper.d("Contact ID = " + contactID);
        viewHolder.setContactID(contactID);

        // get the contact name
        String contactName = cursor.getString(cursor.getColumnIndex(AddressBookDatabaseDescription.Contact.COLUMN_NAME_F));
